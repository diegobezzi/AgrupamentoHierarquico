...
def main():
    ...
    st.set_page_config(
        ...
        page_icon='https://raw.githubusercontent.com/diegobezzi/Projeto_Previsao_Renda/main/ebac-course-utils/icon/favicon.ico', 
        layout="wide",
    ...
    st.sidebar.markdown('''
                        <div style="text-align:center">
                            <img src="https://raw.githubusercontent.com/diegobezzi/DataScience_Estudos/main/ebac-course-utils/media/logo/ebac_logo-data_science.png" alt="ebac-logo" width=50%>
                        </div>

                        # **Profissão: Cientista de Dados**
                        ### **Projeto de Agrupamento Hierárquico**

                        **Por:** [Diego Perez Bezzi Vilas Boas](https://www.linkedin.com/in/diegobezzi/)<br>
                        **Data:** 19 de Agosto de 2024.<br>
    ...
    st.sidebar.markdown('''
                        ---
                        *Baseado no [Exercício 2](https://github.com/diegobezzi/DataScience_Estudos/blob/main/mod30_tarefa02-DiegoPBVBoas.ipynb) do [Módulo 30](https://github.com/diegobezzi/DataScience_Estudos).*
                        ''')
    ...
    with st.echo():
        ...
        df = pd.read_csv('https://raw.githubusercontent.com/diegobezzi/AgrupamentoHierarquico/main/online_shoppers_intention.csv')
